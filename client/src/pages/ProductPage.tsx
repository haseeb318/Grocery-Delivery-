  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <button
          onClick={() => navigate(-1)}
          className="mb-6 flex item-center gap-1.5 text-sm text-app-text-light 
        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="mb-6">
                {product.stock > 0 ? (
                  <span className="text-sm font-medium text-app-success">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-50
                    disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-green text-app-green border border-app-cream" : "bg-app-orange text-white hover:bg-app-orange-dark"}
                    `}
                >
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                className="text-sm font-semibold text-app-orange hover:text-app-orange-dark flex 
                item-center gap-1 transition-colors"
                to={`/products?category=${product.category}`}
              >
