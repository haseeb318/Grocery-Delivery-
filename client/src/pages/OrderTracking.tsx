      ...
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-app-green">
              Order #{order!._id.slice(-8).toLocaleLowerCase()}
            </h1>
          ...
          <span
            ...
            ${order?.status === "Delivered" ? "bg-green-100 text-green-700" : order!.status === "Cancelled" ? "bg-red-100 text-red-700" : "bg-app-orange/10 text-app-orange"}`}
          >
            {order!.status}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 ">
                ...
                <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-app-text-light captilize">
          ...
          <div className="space-y-5">
            ...
            {/* Item */}
            <div className="bg-white rounded-xl p-5">
              <h3 className="text-sm font-medium text-app-green mb-3">
              ...
              <div className="mt-4 pt-3 border-t border-app-border space-y-1.5 text-sm">
                ...
                <div className="flex justify-between pt-2 border-t border-app-border font-semibold text-">
