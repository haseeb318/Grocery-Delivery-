    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {steps.map((s, i) => (
            <div key={s.key} className="flex items-center gap-2 ">
              <button
                ...
                className={`flex item-center gap-2 px-4 py-2 rounded-xl text-sm font-medium
                transition-colors ${step === s.key ? "bg-app-green text-white" : "bg-white text-app-text-light"}`}
              >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            {step === "address" && (
              <CheckoutReview
                address={address}
                items={items}
                handlePlaceOrder={handlePlaceHolder}
                loading={loading}
                total={total}
              />
            )}
          ...
          <div className="bg-white p-5 rounded-2xl h-fit stricky top-24">
