            ...
            {loading ? (
              ...
              <div className=" text-center py-16">
                ...
                <p className="text-sm font-semibold text-app-text-light mb-4">
                  Try adjusting adjusting your filter and terms
                </p>
                <button
              ...
              <div className="flex-center gap-2 mt-16">
                {Array.from({ length: totalPages }).map((_, i) => (
                  <button
                    ...
                    key={i}
                    className={`size-9 rounded-lg text-sm font-medium transition-color ${
                      page === i + 1
        ...
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
            <div className="flex items-center justify-between p-4 border-b border-app-border">
              ...
              <button
                onClick={() => setMobileFilterOpen(false)}
                className="p-2 hover:bg-app-crean rounded-lg"
              >
