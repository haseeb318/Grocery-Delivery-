...
function ProductCard({ product }: props) {
  ...
  transition-all duration-300 group animation-fade-in cursor-pointer "
      ...
      <div className="p-3.5 text-zinc-700">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className=" size-7 
          rounded-full bg-app-orange text-white 
          flex-center shrink-0 hover:bg-app-orange-dark
          transition-color active:scale-95"
          >
            <Plus className="3.5" />
          </button>
        </div>
