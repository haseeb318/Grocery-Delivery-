...
function Banner() {
  const [bannerVissible, setBannerVissible] = useState(() => {
    return sessionStorage.getItem("banner_dismissed") !== "true";
  });
  const dismissBanner = () => {
    setBannerVissible(false);
    sessionStorage.setItem("banner_dismissed", "true");
  };
  return (
    <div className="text-xs sm:text-sm py-2 bg-linear-to-r from-app-green via-[#006045] to-app-green text-white font-sans relative overflow-hidden">
