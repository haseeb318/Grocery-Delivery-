...
interface AddressCardProps {
  ...
  setAddressess: (addresses: Address[]) => void;
}
function AddressCard({ addr, onEditHandler, setAddressess }: AddressCardProps) {
    ...
    >
      ...
      <div className="flex gap-4">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            {addr.isDefault && (
              <span
                className="flex-center gap-1 px-2.5 py-0.5 text-[10px] font-medium bg-app-green
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-2 text-app-green-light hover:text-app-green hover:bg-app-cream
