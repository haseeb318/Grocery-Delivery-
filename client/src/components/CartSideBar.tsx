...
function CartSideBar() {
  ...
  return (
    <>
      ...
      {/* sidebar */}
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animation-slide-in-right">
        {/* header  */}
        <div className="flex items-center justify-between p-5 border-b border-app-border">
          ...
          <button
            onClick={() => setIsCartOpen(false)}
            className="p-2 rounded-xl hover:bg-app-cream transition-all"
          >
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              <ShoppingBagIcon className="sixe-16 text-app-border mb-4" />
          ...
          <div className=" p-5 border-t border-app-border space-y-3">
            ...
            {deliveryFee > 0 && (
              <p className="text-xs text-app-text-light text-center">
                Free delivery order over{currency} 20!
              </p>
            )}
